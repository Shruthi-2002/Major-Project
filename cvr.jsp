...
try{ 
        ...
        PreparedStatement pst=co.prepareStatement("select * from cloudrequest where status='request_sent'  ");
        ResultSet rs=pst.executeQuery();
    
    %>
<div class="plans-container container-fluid" style="padding-left :70px ! important;" >
  <div class="container">
  ...
  <table class="table" style="padding-left :70px ! important;">
    <thead>
      <tr>
        <th>User</th>
        <th>Owner</th>
    ...
    <tbody>
     <tr>
        ...
        <td><a href="cvr1.jsp?user=<%=rs.getString(1)%>&edisease=<%=rs.getString(6)%>&owner=<%=rs.getString(2)%>">Sent_Mail</a></td>
