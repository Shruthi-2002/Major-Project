    ...
    <div class="container-fluid">
     ...
     <div id="collapseExample" class="nav-col">
      <ul>
        ...
        <li><a href="cvr.jsp">Cloud View Requests</a></li>
  ...
  <table class="table">
    ...
    <tbody>
     <tr>
        ...
        <td><a href="cvf1.jsp?email=<%=rs.getString(1)%>&hb=<%=rs.getString(2)%>&tempr=<%=rs.getString(3)%>&ox=<%=rs.getString(4)%>&dise=<%=rs.getString(5)%>">Send</a></td>
