...
try{ 
        ...
        PreparedStatement pst=co.prepareStatement("select * from upload where email='"+email+"' and status='pending' ");
  ...
  <table class="table">
    ...
    <tbody>
     <tr>
        ...
        <td><a href="sf.jsp?email=<%=rs.getString(1)%>&edisease=<%=rs.getString(13)%>&eox=<%=rs.getString(12)%>">Send</a></td>
