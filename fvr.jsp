...
try{ 
        ...
        PreparedStatement pst=co.prepareStatement("select * from fogrequest where status='request_sent' ");
        ResultSet rs=pst.executeQuery();
    
    %>
<div class="plans-container container-fluid" style="padding-left :0px">
  <div class="container">
  ...
  <table class="table" style="padding-left :20px">
    ...
    <tbody>
     <tr>
        ...
        <td><a href="fvr1.jsp?user=<%=rs.getString(1)%>&edisease=<%=rs.getString(6)%>&owner=<%=rs.getString(2)%>&role=<%=rs.getString(13)%>&timet1=<%=rs.getString(14)%>">Verify & Send mail</a></td>
