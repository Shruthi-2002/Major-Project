...
try{ 
        ...
        PreparedStatement pst=co.prepareStatement("select * from cloudrequest where status='key1_sent' ");
  ...
  <table class="table">
    ...
    <tbody>
     <tr>
        ...
        <td><a href="cvr3.jsp?user=<%=rs.getString(1)%>&edisease=<%=rs.getString(6)%>&owner=<%=rs.getString(2)%>">Sent_Mail</a></td>
