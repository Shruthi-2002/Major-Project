...
try{ 
        ...
        PreparedStatement pst=co.prepareStatement("select * from cloudrequest where status='key4_sent' ");
  ...
  <table class="table">
    ...
    <tbody>
     <tr>
        ...
        <td><a href="cvr9.jsp?user=<%=rs.getString(1)%>&edisease=<%=rs.getString(6)%>&owner=<%=rs.getString(2)%>">Sent_Mail</a></td>
