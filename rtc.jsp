  ...
  <table class="table">
    ...
    <tbody>
     <tr>
        ...
        <td><a href="rtc1.jsp?email=<%=rs.getString(1)%>&edisease=<%=rs.getString(13)%>&eox=<%=rs.getString(12)%>&eheartbeat=<%=rs.getString(10)%>&etemprature=<%=rs.getString(11)%>&eimage=<%=rs.getString(15)%>&role=<%=rs.getString(18)%>&t1=<%=rs.getString(19)%>">Send_to_Cloud</a></td>
