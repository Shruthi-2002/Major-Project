...
try{ 
        ...
        PreparedStatement pst=co.prepareStatement("select * from fogrequest where status='mail_sent' ");
  ...
  <table class="table">
    ...
    <tbody>
     <tr>
        ...
        <td><a href="fd1.jsp?user=<%=rs.getString(1)%>&owner=<%=rs.getString(2)%>&edisease=<%=rs.getString("edisease")%>&timet1=<%=rs.getString("timet1")%>">Download</a></td>
