  ...
  <div class="container">
    ...
    String ft = dateFormat.format(currentDate);
        ...
        //     String eimage=request.getParameter("eimage");
          %>
      <center>
          <h3 style="color:black;">Heartbeat : <%=ehb%></h3><br>
          <%}%>
          
           <h3 style="color:black;">Verify</h3><br>
        <form style="width: 40%;" action="cd3.jsp" >
                                
  <!-- Email input -->
  <div class="form-outline mb-4">
      <input type="text"  name="skey1" id="form2Example1" placeholder="Key2" required class="form-control" />
  </div>
