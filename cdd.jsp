...
try{ 
        ...
        PreparedStatement pst=co.prepareStatement("select * from cloudrequest where status='key5_sent' ");
  ...
  <table class="table">
    ...
    <tbody>
     <tr>
        ...
        <td><a href="cd1.jsp?user=<%=rs.getString(1)%>&owner=<%=rs.getString(2)%>&edisease=<%=rs.getString("edisease")%>&timet1=<%=rs.getString("timet1")%>">Download</a></td>
